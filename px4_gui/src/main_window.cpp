...
// row 1
    ...
    ui->plot_1_1->addGraph(); // red dot
    ui->plot_1_1->graph(0)->setPen(redPen); //pose x
ui->plot_1_1->graph(0)->setLineStyle(QCPGraph::lsNone);
ui->plot_1_1->graph(0)->setScatterStyle(QCPScatterStyle(QCPScatterStyle::ssCircle, 2));
    //reference line
    ...
    ui->plot_1_2->addGraph(); // green dot
    ui->plot_1_2->graph(0)->setPen(greenPen); //pose y
ui->plot_1_2->graph(0)->setLineStyle(QCPGraph::lsNone);
ui->plot_1_2->graph(0)->setScatterStyle(QCPScatterStyle(QCPScatterStyle::ssCircle, 2));
    //reference line
    ...
    ui->plot_1_3->addGraph(); // blue dot
    //ui->plot_1_3->graph(0)->setPen(QColor(0, 0, 255, 120));
ui->plot_1_3->graph(0)->setPen(bluePen);
ui->plot_1_3->graph(0)->setLineStyle(QCPGraph::lsNone);
ui->plot_1_3->graph(0)->setScatterStyle(QCPScatterStyle(QCPScatterStyle::ssCircle, 2));
...
ui->plot_1_4->graph(0)->setLineStyle(QCPGraph::lsNone);
ui->plot_1_4->graph(0)->setScatterStyle(QCPScatterStyle(QCPScatterStyle::ssCircle, 2));
...
//velo setpoint 1234
//velo_yaw 123
    ui->plot_2_1->addGraph(); // red dot
    ui->plot_2_1->graph(0)->setPen(redPen); // velo x
ui->plot_2_1->graph(0)->setLineStyle(QCPGraph::lsNone);
ui->plot_2_1->graph(0)->setScatterStyle(QCPScatterStyle(QCPScatterStyle::ssCircle, 2));
    ...
    ui->plot_2_2->addGraph(); // green dot
    ui->plot_2_2->graph(0)->setPen(greenPen); // velo y
ui->plot_2_2->graph(0)->setLineStyle(QCPGraph::lsNone);
ui->plot_2_2->graph(0)->setScatterStyle(QCPScatterStyle(QCPScatterStyle::ssCircle, 2));
    ...
    ui->plot_2_3->addGraph(); // blue dot
    ui->plot_2_3->graph(0)->setPen(bluePen); // velo z
ui->plot_2_3->graph(0)->setLineStyle(QCPGraph::lsNone);
ui->plot_2_3->graph(0)->setScatterStyle(QCPScatterStyle(QCPScatterStyle::ssCircle, 2));
...
//qDebug() << "entered if !!!!!!!!!!!!!!!!!!!!!!!!!!!!!";
    ...
    {
        ui->pose_z_label->setStyleSheet("color:black;");
    }
